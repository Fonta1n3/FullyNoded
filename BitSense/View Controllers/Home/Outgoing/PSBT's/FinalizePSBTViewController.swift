//
//  FinalizePSBTViewController.swift
//  BitSense
//
...
class FinalizePSBTViewController: UIViewController {
    ...
    @IBAction func finalizeNow(_ sender: Any) {
    ...
    @objc func encodeText() {
        ...
        DispatchQueue.main.async {
            ...
            self.rawDisplayer.textView.text = self.rawTx
    ...
    func displayRaw(raw: String) {
        ...
        DispatchQueue.main.async {
            ...
            self.rawDisplayer.titleString = "Raw Transaction"
