...
class LogInViewController: UIViewController, UITextFieldDelegate {
    ...
    func savePassword(password: String) {
        ...
        if saveSuccessful {
            ...
            print("nodePassword = \(String(describing: KeychainWrapper.standard.string(forKey: "NodePassword")))")
    ...
    func saveIPAdress(ipAddress: String) {
        ...
        if saveSuccessful {
            ...
            print("nodeIPAddress = \(String(describing: KeychainWrapper.standard.string(forKey: "NodeIPAddress")))")
    ...
    func savePort(port: String) {
        ...
        if saveSuccessful {
            ...
            print("nodePort = \(String(describing: KeychainWrapper.standard.string(forKey: "NodePort")))")
    ...
    func saveUsername(username: String) {
        ...
        if saveSuccessful {
            ...
            print("username = \(String(describing: KeychainWrapper.standard.string(forKey: "NodeUsername")))")
