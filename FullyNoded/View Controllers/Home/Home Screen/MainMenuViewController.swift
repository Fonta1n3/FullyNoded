...
class MainMenuViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let hdkeyur = "ur:crypto-hdkey/osadwkaowkaxhdclaolrmdfznbfnsfdahhcnrdlgjnesmhyniymywsvtpeuefsvsdtamuozecahnkgmdvdaahdcxylmyvdhlfxbgtsjlroaebewndpndksjpgmvaiebzmojojoimkpvoahfmcpjsbbbbahtaadehoyaoadamtaaddyotadlocsdyykadykaeykaoykaocyjlgaldjsaxaaaycymkcemojtbahlktrk"
        
        let output = "ur:crypto-"
        
        URHelper.parseUr(urString: account)
        URHelper.parseUr(urString: hdkeyur)
        URHelper.parseUr(urString: output)
    }
